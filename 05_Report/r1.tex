...
\begin{figure}[H]
    \centering
    \includegraphics[width=0.45\textwidth]{./media/moderate_load.png}
    \caption{Moderate load on RPi}
    \label{fig:moderate_load}
\end{figure}
